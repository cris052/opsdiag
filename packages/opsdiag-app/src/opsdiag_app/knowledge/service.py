...
from opsdiag.configs import DOMAIN_TYPE_FINANCIAL_REPORT
from opsdiag.configs.model_config import EMBEDDING_MODEL_CONFIG
from opsdiag.core import LLMClient
from opsdiag.model import DefaultLLMClient
from opsdiag.model.cluster import WorkerManagerFactory
from opsdiag.rag.knowledge.base import KnowledgeType
from opsdiag.rag.retriever.rerank import RerankEmbeddingsRanker
from opsdiag.util.executor_utils import ExecutorFactory, blocking_func_to_async
from opsdiag.util.string_utils import remove_trailing_punctuation
from opsdiag.util.tracer import root_tracer, trace
from opsdiag_app.knowledge.request.request import (
    ChunkQueryRequest,
...
from opsdiag_app.knowledge.request.response import (
    ChunkQueryResponse,
    DocumentQueryResponse,
    DocumentResponse,
    SpaceQueryResponse,
)
from opsdiag_ext.rag.assembler.summary import SummaryAssembler
from opsdiag_ext.rag.chunk_manager import ChunkParameters
from opsdiag_ext.rag.knowledge.factory import KnowledgeFactory
from opsdiag_serve.rag.models.chunk_db import DocumentChunkDao, DocumentChunkEntity
from opsdiag_serve.rag.models.document_db import (
    KnowledgeDocumentDao,
    KnowledgeDocumentEntity,
)
from opsdiag_serve.rag.models.models import KnowledgeSpaceDao, KnowledgeSpaceEntity
from opsdiag_serve.rag.models.yuque_db import KnowledgeYuqueDao, KnowledgeYuqueEntity
from opsdiag_serve.rag.retriever.knowledge_space import KnowledgeSpaceRetriever
from opsdiag_serve.rag.service.service import SyncStatus
...
class KnowledgeService:
    ...
    async def document_summary(self, request: DocumentSummaryRequest):
        ...
        if (
            ...
            from opsdiag_serve.rag.service.service import Service
    ...
    async def recall_test(
        ...
        from opsdiag.rag.embedding.embedding_factory import RerankEmbeddingFactory
    ...
    def _build_default_context(self):
        from opsdiag_app.scene.chat_knowledge.v1.prompt import (
            _DEFAULT_TEMPLATE,
            PROMPT_SCENE_DEFINE,
        )
    ...
    async def _llm_extract_summary(
        ...
        """
        from opsdiag_app.scene import ChatParam, ChatScene
        ...
        from opsdiag_app.openapi.api_v1.api_v1 import CHAT_FACTORY
