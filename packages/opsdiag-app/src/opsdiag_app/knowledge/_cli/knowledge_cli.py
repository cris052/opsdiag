...
from opsdiag.configs.model_config import DATASETS_DIR
...
def load(
    ...
    from opsdiag_app.knowledge._cli.knowledge_client import knowledge_init
...
def delete(space_name: str, doc_name: str, y: bool):
    ...
    from opsdiag_app.knowledge._cli.knowledge_client import knowledge_delete
...
def list(
    ...
    from opsdiag_app.knowledge._cli.knowledge_client import knowledge_list
