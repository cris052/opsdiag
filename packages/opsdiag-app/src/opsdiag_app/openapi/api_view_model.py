...
from opsdiag._private.pydantic import BaseModel, ConfigDict, Field, model_to_dict
from opsdiag.core.schema.types import ChatCompletionUserMessageParam
from opsdiag_serve.building.config.api.schemas import ChatInParamValue
