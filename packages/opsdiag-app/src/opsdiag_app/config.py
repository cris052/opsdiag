...
from opsdiag.storage.cache.manager import ModelCacheParameters
from opsdiag.storage.vector_store.base import VectorStoreConfig
from opsdiag.util.configure import HookConfig
from opsdiag.util.i18n_utils import _
from opsdiag.util.parameter_utils import BaseParameters
from opsdiag.util.tracer import TracerParameters
from opsdiag.util.logger import LoggingParameters
...
from opsdiag_serve.core.config import GPTsAppConfig
...
class ServiceWebParameters(BaseParameters):
    ...
    database: BaseDatasourceParameters = field(
        default_factory=lambda: SQLiteConnectorParameters(
            path="pilot/meta_data/opsdiag.db"
        ),
        metadata={
            "help": _(
