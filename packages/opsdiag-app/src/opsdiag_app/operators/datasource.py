...
from opsdiag.agent.resource.database import DBResource
from opsdiag.core import Chunk
from opsdiag.core.awel import DAGContext, MapOperator
...
from opsdiag.core.operators import BaseLLM
from opsdiag.util.i18n_utils import _
from opsdiag_ext.vis.gptvis.tags.vis_db_chart import VisDbChart, default_chart_type_prompt
...
class HODatasourceDashboardOperator(GPTVisMixin, MapOperator[dict, str]):
    ...
    async def map(self, sql_dict_list: List[dict]) -> str:
        """Execute the context from the datasource."""
        from opsdiag_ext.vis.gptvis.tags.vis_dashboard import VisDashboard
