...
from opsdiag.core.awel import DAG, BaseOperator, DAGVar
from opsdiag.core.awel.dag.dag_manager import DAGMetadata, _parse_metadata
from opsdiag.core.awel.flow.flow_factory import FlowFactory
...
def _check_local_dag(
    ...
    from opsdiag.core.awel import HttpTrigger
...
def _parse_local_dag(name: str, filepath: str | None = None) -> Tuple[DAG, DAGMetadata]:
    ...
    if not filepath:
        ...
        from opsdiag.util.derisks.loader import (
        ...
        from opsdiag.core.awel.dag.loader import _process_file
