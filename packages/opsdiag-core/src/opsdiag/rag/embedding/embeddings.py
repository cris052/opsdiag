...
from opsdiag._private.pydantic import EXTRA_FORBID, BaseModel, ConfigDict, Field
from opsdiag.core import EmbeddingModelMetadata, Embeddings
from opsdiag.core.awel.flow import Parameter, ResourceCategory, register_resource
from opsdiag.core.interface.parameter import EmbeddingDeployModelParameters
from opsdiag.model.adapter.base import register_embedding_adapter
from opsdiag.model.adapter.embed_metadata import (
    EMBED_COMMON_HF_BGE_MODELS,
    EMBED_COMMON_HF_JINA_MODELS,
)
from opsdiag.util.i18n_utils import _
from opsdiag.util.tracer import DERISK_TRACER_SPAN_ID, root_tracer
...
class HuggingFaceEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from opsdiag.rag.embedding import HuggingFaceEmbeddings
...
class HuggingFaceInstructEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from opsdiag.rag.embeddings import HuggingFaceInstructEmbeddings
...
class HuggingFaceBgeEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from opsdiag.rag.embeddings import HuggingFaceBgeEmbeddings
...
class OpenAPIEmbeddings(BaseModel, Embeddings):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from opsdiag.rag.embedding import OpenAPIEmbeddings
        ...
        <https://docs.opsdiag.site/docs/installation/model_service/cluster>`_.
