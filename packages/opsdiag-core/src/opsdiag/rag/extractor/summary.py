...
from opsdiag.core import Chunk, LLMClient, ModelMessageRoleType, ModelRequest
from opsdiag.rag.extractor.base import Extractor
from opsdiag.util import logger
...
class SummaryExtractor(Extractor):
    ...
    async def _aextract(self, chunks: List[Chunk]) -> str:
        ...
        from opsdiag.util.prompt_util import PromptHelper
