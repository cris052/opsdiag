...
from opsdiag.core import MessageConverter, ModelMetadata, ModelOutput, ModelRequest
...
from opsdiag.model.proxy.base import (
    AsyncGenerateStreamFunction,
    GenerateStreamFunction,
    ProxyLLMClient,
    register_proxy_model_adapter,
)
from opsdiag.model.proxy.llms.proxy_model import ProxyModel, parse_model_request
from opsdiag.model.utils.chatgpt_utils import OpenAIParameters
...
class OpenAILLMClient(ProxyLLMClient):
    ...
    def client(self) -> "ClientType":
        if self._client is None:
            from opsdiag.model.utils.chatgpt_utils import _build_openai_client
