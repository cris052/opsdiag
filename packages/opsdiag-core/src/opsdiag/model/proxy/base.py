...
from opsdiag.util.configure.manager import _resolve_env_vars
...
def register_proxy_model_adapter(
    ...
    """
    from opsdiag.model.adapter.base import register_model_adapter
    from opsdiag.model.adapter.proxy_adapter import ProxyLLMModelAdapter
