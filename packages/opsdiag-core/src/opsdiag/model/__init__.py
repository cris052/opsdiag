try:
    from opsdiag.model.cluster.client import DefaultLLMClient, RemoteLLMClient
except ImportError:
...
def scan_model_providers():
    ...
    config = ScannerConfig(
        module_path="opsdiag.model.adapter",
