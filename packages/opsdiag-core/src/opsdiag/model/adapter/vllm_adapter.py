...
from opsdiag.core import ModelMessage
from opsdiag.core.interface.parameter import LLMDeployModelParameters
from opsdiag.model.adapter.base import LLMModelAdapter, register_model_adapter
from opsdiag.model.adapter.model_metadata import COMMON_HF_MODELS
from opsdiag.model.adapter.template import ConversationAdapter, ConversationAdapterFactory
from opsdiag.model.base import ModelType
...
class VLLMModelAdapterWrapper(LLMModelAdapter):
    ...
    def __init__(self, conv_factory: Optional[ConversationAdapterFactory] = None):
        if not conv_factory:
            from opsdiag.model.adapter.model_adapter import (
    ...
    def get_async_generate_stream_function(
        ...
        from opsdiag.model.llm.llm_out.vllm_llm import generate_stream
