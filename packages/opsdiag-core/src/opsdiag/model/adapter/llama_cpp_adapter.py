...
from opsdiag.model.adapter.base import (
    ConversationAdapter,
    LLMModelAdapter,
    register_model_adapter,
)
from opsdiag.model.adapter.model_metadata import COMMON_LLAMA_CPP_MODELS
...
class LLamaServerModelAdapter(LLMModelAdapter):
    ...
    def get_generate_stream_function(
        ...
        from opsdiag.model.llm.llama_cpp.llama_cpp_server import generate_stream
    ...
    def get_generate_function(
        ...
        from opsdiag.model.llm.llama_cpp.llama_cpp_server import generate
