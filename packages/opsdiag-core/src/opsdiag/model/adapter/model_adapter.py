...
from opsdiag.model.adapter.base import LLMModelAdapter, get_model_adapter
...
def get_llm_model_adapter(
    ...
    if use_fastchat:
        ...
        from opsdiag.model.adapter.fschat_adapter import (
...
def _dynamic_model_parser() -> Optional[List[Type[LLMDeployModelParameters]]]:
    ...
    """
    from opsdiag.model.adapter.base import get_embedding_adapter
