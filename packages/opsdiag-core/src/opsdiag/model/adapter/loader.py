...
from opsdiag.util import get_gpu_memory
from opsdiag.util.parameter_utils import _genenv_ignoring_key_case
...
def huggingface_loader(
    ...
    from opsdiag.model.llm.compression import compress_module
    ...
    if device == "cpu":
        ...
        if version < (4, 35, 0):
            from opsdiag.model.llm.monkey_patch import (
