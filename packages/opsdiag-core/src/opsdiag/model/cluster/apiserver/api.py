...
from opsdiag._private.pydantic import BaseModel, model_to_dict
from opsdiag.component import BaseComponent, ComponentType, SystemApp
from opsdiag.core import ModelOutput
from opsdiag.core.interface.message import ModelMessage
from opsdiag.core.schema.api import (
...
from opsdiag.model.base import ModelInstance
...
from opsdiag.model.parameter import ModelAPIServerParameters, WorkerType
from opsdiag.util.chat_util import transform_to_sse
from opsdiag.util.fastapi import create_app
from opsdiag.util.tracer import initialize_tracer, root_tracer
...
class APIServer(BaseComponent):
    ...
    async def embeddings_generate(
        ...
        with root_tracer.start_span(
            "opsdiag.model.apiserver.generate_embeddings",
...
async def create_chat_completion(
    ...
    trace_kwargs = {
        "operation_name": "opsdiag.model.apiserver.create_chat_completion",
        "metadata": {
            "model": request.model,
...
async def create_completion(
    ...
    trace_kwargs = {
        "operation_name": "opsdiag.model.apiserver.create_completion",
...
async def create_relevance(
    ...
    with root_tracer.start_span(
        "opsdiag.model.apiserver.generate_relevance",
        metadata={
            "model": request.model,
            "query": request.query,
        },
...
def _initialize_all(controller_addr: str, system_app: SystemApp):
    ...
    from opsdiag.model.cluster.worker.manager import _DefaultWorkerManagerFactory
