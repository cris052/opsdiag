...
from opsdiag.configs.model_config import get_device
...
from opsdiag.model.adapter.base import LLMModelAdapter
from opsdiag.model.adapter.loader import ModelLoader
from opsdiag.model.adapter.model_adapter import get_llm_model_adapter
from opsdiag.model.cluster.worker_base import ModelWorker
from opsdiag.util.model_utils import _clear_model_cache, _get_current_cuda_memory
from opsdiag.util.parameter_utils import _get_dict_from_obj
from opsdiag.util.system_utils import get_system_info
from opsdiag.util.tracer import SpanType, SpanTypeRunName, root_tracer
...
class DefaultModelWorker(ModelWorker):
    ...
    async def async_count_token(self, prompt: str) -> int:
        ...
        from opsdiag.model.proxy.llms.proxy_model import ProxyModel
