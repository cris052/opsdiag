...
from opsdiag.core import ModelMetadata, ModelOutput
from opsdiag.core.interface.parameter import (
    BaseDeployModelParameters,
    EmbeddingDeployModelParameters,
    LLMDeployModelParameters,
    RerankerDeployModelParameters,
)
from opsdiag.model.base import ModelInstance, WorkerApplyOutput, WorkerSupportedModel
...
from opsdiag.model.cluster.manager_base import (
    WorkerManager,
    WorkerManagerFactory,
    WorkerRunData,
)
from opsdiag.model.cluster.registry import ModelRegistry
from opsdiag.model.cluster.storage import ModelStorage, ModelStorageItem
...
from opsdiag.model.utils.llm_utils import list_supported_models
from opsdiag.util.fastapi import create_app, register_event_handler
...
from opsdiag.util.tracer.tracer_impl import TracerParameters
...
def _setup_fastapi(
    ...
    if worker_params.standalone:
        from opsdiag.model.cluster.controller.controller import initialize_controller
...
def _create_local_model_manager(
    ...
    from opsdiag.util.net_utils import _get_ip_address
    ...
    if not worker_params.register or not worker_params.controller_addr:
        ...
        from opsdiag.model.cluster.controller.controller import ModelRegistryClient
...
def _build_worker(
    ...
    if worker_class:
        from opsdiag.util.module_utils import import_from_checked_string
        ...
        if worker_type is None or worker_type == WorkerType.LLM:
            ...
            from opsdiag.model.cluster.worker.embedding_worker import (
...
def _parse_config(config_file: str):
    from opsdiag.configs.model_config import ROOT_PATH
