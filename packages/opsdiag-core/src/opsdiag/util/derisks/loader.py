...
from opsdiag.component import BaseComponent, SystemApp
from opsdiag.core.awel import DAG
from opsdiag.core.awel.flow.flow_factory import FlowPanel
from opsdiag.util.derisks.base import (
...
class BasePackage(BaseModel):
    ...
    def load_module_class(
        ...
        from opsdiag.core.awel.dag.loader import _load_modules_from_file
...
class FlowPythonPackage(FlowPackage):
    ...
    @classmethod
    def build_from(cls, values: Dict[str, Any], ext_dict: Dict[str, Any]):
        from opsdiag.core.awel.dag.loader import _process_modules
...
class ResourcePackage(BasePackage):
    ...
    @classmethod
    def build_from(cls, values: Dict[str, Any], ext_dict: Dict[str, Any]):
        from opsdiag.agent.resource import Resource
        from opsdiag.agent.resource.tool.pack import _is_function_tool
