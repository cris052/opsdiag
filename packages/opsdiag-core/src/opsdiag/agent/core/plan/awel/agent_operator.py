...
from opsdiag.core.awel.trigger.base import Trigger
from opsdiag.core.interface.message import ModelMessageRoleType

# TODO: Don't dependent on MixinLLMOperator
from opsdiag.model.operators.llm_operator import MixinLLMOperator
