...
from opsdiag._private.pydantic import BaseModel, ConfigDict, Field, model_validator
...
def _agent_resource_prompt_values() -> List[OptionValue]:
    from opsdiag_serve.prompt.api.endpoints import get_service
...
@register_resource(
    ...
    alias=[
        "opsdiag.serve.agent.team.layout.agent_operator_resource.AwelAgentResource",
        "opsdiag.agent.core.reasoning_engine.awel.agent_operator_resource.AWELAgentResource",
    ],
)
...
def _agent_resource_knowledge_values(
    ...
    from opsdiag_app.knowledge.api import knowledge_space_service
...
@register_resource(
    ...
    alias=[
        "opsdiag.serve.agent.team.layout.agent_operator_resource.AwelAgentKnowledgeResource",  # noqa
        "opsdiag.agent.core.reasoning_engine.awel.agent_operator_resource.AWELAgentKnowledgeResource",
    ],
)
...
@register_resource(
    ...
    alias=[
        "opsdiag.serve.agent.team.layout.agent_operator_resource.AgentPrompt",
        "opsdiag.agent.core.reasoning_engine.awel.agent_operator_resource.AgentPrompt",
    ],
)
...
@register_resource(
    ...
    alias=[
        "opsdiag.serve.agent.team.layout.agent_operator_resource.AwelAgentConfig",
        "opsdiag.agent.core.reasoning_engine.awel.agent_operator_resource.AWELAgentConfig",
    ],
)
...
@register_resource(
    ...
    alias=[
        "opsdiag.serve.agent.team.layout.agent_operator_resource.AwelAgent",
        "opsdiag.agent.core.reasoning_engine.awel.agent_operator_resource.AWELAgent",
    ],
)
