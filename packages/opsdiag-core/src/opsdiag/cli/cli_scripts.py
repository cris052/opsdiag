...
try:
    from opsdiag_app.knowledge._cli.knowledge_cli import knowledge_cli_group
...
try:
    from opsdiag.util.tracer.tracer_cli import trace_cli_group
...
try:
    from opsdiag_serve.utils.cli import serve
...
try:
    from opsdiag.util.cli.flow_compat import tool_flow_cli_group
    from opsdiag.util.derisks.cli import (
        add_repo,
        list_installed_apps,
        list_repos,
        new_derisks,
    ...
    from opsdiag.util.derisks.cli import install as app_install
    from opsdiag.util.derisks.cli import list_all_apps as app_list_remote
    from opsdiag.util.derisks.cli import uninstall as app_uninstall
...
try:
    from opsdiag_client._cli import flow as run_flow
...
try:
    from opsdiag.util.network._cli import start_forward
