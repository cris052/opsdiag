...
from opsdiag.util.singleton import Singleton

if TYPE_CHECKING:
    from opsdiag.component import SystemApp
    from opsdiag.datasource.manages import ConnectorManager
...
class Config(metaclass=Singleton):
    ...
    def __init__(self) -> None:
        ...
        from opsdiag.core._private.prompt_registry import PromptTemplateRegistry
