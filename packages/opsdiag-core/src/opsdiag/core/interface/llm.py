...
from opsdiag.core.interface.media import MediaContent, MediaContentType, MediaObject
from opsdiag.core.interface.message import ModelMessage, ModelMessageRoleType
from opsdiag.util import BaseParameters
from opsdiag.util.annotations import PublicAPI
from opsdiag.util.model_utils import GPUInfo
from opsdiag.vis import Vis
    ...
    def to_common_messages(
        ...
        Examples:
            .. code-block:: python
                ...
                from opsdiag.core.interface.message import (
                    ModelMessage,
...
class MessageConverter(ABC):
    ...
    Examples:
        ...
        >>> from opsdiag.core.interface.message import ModelMessage, ModelMessageRoleType
        >>> from opsdiag.core.interface.llm import MessageConverter, ModelMetadata
...
class DefaultMessageConverter(MessageConverter):
    ...
    def convert_to_no_system_message(
        ...
        Examples:
            ...
            ...     ModelMessageRoleType,
            ... )
            >>> from opsdiag.core.interface.llm import (
    ...
    def move_last_user_message_to_end(
        ...
        Examples:
            ...
            ...     ModelMessageRoleType,
            ... )
            >>> from opsdiag.core.interface.llm import DefaultMessageConverter
            >>> messages = [
            ...     ModelMessage(
            ...         role=ModelMessageRoleType.SYSTEM,
            ...         content="You are a helpful assistant",
