...
from opsdiag.core.awel import BaseOperator, MapOperator
...
class BufferedConversationMapperOperator(ConversationMapperOperator):
    ...
    Examples:
        .. code-block:: python
            ...
            import asyncio
            from opsdiag.core.interface.message import AIMessage, HumanMessage
            from opsdiag.core.operators import BufferedConversationMapperOperator
    ...
    def _filter_round_messages(
        ...
        Examples:
            >>> from opsdiag.core import AIMessage, HumanMessage
            >>> from opsdiag.core.operators import BufferedConversationMapperOperator
            >>> messages = [
            ...     [
            ...         HumanMessage(content="Hi", round_index=1),
