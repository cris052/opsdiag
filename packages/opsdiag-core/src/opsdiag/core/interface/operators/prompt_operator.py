...
from opsdiag._private.pydantic import model_validator
from opsdiag.core import ModelMessage, ModelOutput, StorageConversation
from opsdiag.core.awel import JoinOperator, MapOperator
...
from opsdiag.core.interface.message import BaseMessage
from opsdiag.core.interface.operators.llm_operator import BaseLLM
from opsdiag.core.interface.operators.message_operator import BaseConversationOperator
...
class PromptBuilderOperator(
    ...
    Examples:
        .. code-block:: python
            ...
            import asyncio
            from opsdiag.core.awel import DAG
            ...
            from opsdiag.core.operators import PromptBuilderOperator
