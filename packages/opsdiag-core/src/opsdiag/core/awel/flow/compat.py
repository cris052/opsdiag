...
_OLD_AGENT_OPERATOR_MODULE = "opsdiag.serve.agent.team.layout.agent_operator"
_NEW_AGENT_OPERATOR_MODULE = "opsdiag.agent.core.reasoning_engine.awel.agent_operator"

_OLD_AGENT_RESOURCE_MODULE_1 = "opsdiag.serve.agent.team.layout.agent_operator_resource"
_OLD_AGENT_RESOURCE_MODULE_2 = (
    "opsdiag.agent.reasoning_engine.awel.agent_operator_resource"
)
_NEW_AGENT_RESOURCE_MODULE = (
    "opsdiag.agent.core.reasoning_engine.awel.agent_operator_resource"
)
...
def get_new_class_name(old_class_name: str) -> Optional[str]:
    ...
    from opsdiag import __version__
...
_register(
    "opsdiag.storage.vector_store.connector",
    "opsdiag.serve.rag.connector",
