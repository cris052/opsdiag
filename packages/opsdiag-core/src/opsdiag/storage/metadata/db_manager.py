...
from opsdiag.util.string_utils import _to_str
    ...
    def paginate_query(self, page: int = 1, per_page: int = 20) -> PaginationResult:
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from opsdiag.storage.metadata import db, Model
...
class DatabaseManager:
    ...
    Examples:
        .. code-block:: python
            ...
            from opsdiag.storage.metadata import DatabaseManager, create_model
