...
from opsdiag.agent import Resource, AgentDummyTrigger
from opsdiag.core import ModelRequest, ModelMessage, ModelOutput, ModelMessageRoleType
from opsdiag.core.awel import DAG, BaseOperator
from opsdiag.core.awel.dag.base import DAGNode
from opsdiag.core.awel.flow import ViewMetadata
from opsdiag.core.awel.flow.flow_factory import FlowPanel, FlowCategory, State, FlowData, FlowPositionData, FlowNodeData, FlowEdgeData
...
from opsdiag_ext.agent.agents.awel.operators import ActionBranchConditionOperator, ActionBranchOperator, ActionOperator, _llm_client, ActionContextStrategy
...
async def build_schema() -> str:
    prompts: list[str] = [prompt for _, cls \
                          in model_scan("opsdiag_ext.agent.agents.awel", Transfer).items() \
