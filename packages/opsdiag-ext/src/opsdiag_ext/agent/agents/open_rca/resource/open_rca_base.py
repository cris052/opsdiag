...
def get_open_rca_background(scene_name: str):
    ...
    match scene:
        case OpenRcaScene.BANK:
            from opsdiag_ext.agent.agents.open_rca.resource.basic_prompt_Bank import schema,data_path
            schema = schema
            data_path = data_path
        case OpenRcaScene.TELECOM:
            from opsdiag_ext.agent.agents.open_rca.resource.basic_prompt_Telecom import schema,data_path
            schema = schema
            data_path = data_path
        case OpenRcaScene.MARKET:
            from opsdiag_ext.agent.agents.open_rca.resource.basic_prompt_Market import schema,data_path
            schema = schema
            data_path = data_path
        case _:
...
def get_open_rca_cand(scene_name: str):
    ...
    match scene:
        case OpenRcaScene.BANK:
            from opsdiag_ext.agent.agents.open_rca.resource.basic_prompt_Bank import cand
            return cand
        case OpenRcaScene.TELECOM:
            from opsdiag_ext.agent.agents.open_rca.resource.basic_prompt_Telecom import cand
            return cand
        case OpenRcaScene.MARKET:
            from opsdiag_ext.agent.agents.open_rca.resource.basic_prompt_Market import cand
            return cand
        case _:
