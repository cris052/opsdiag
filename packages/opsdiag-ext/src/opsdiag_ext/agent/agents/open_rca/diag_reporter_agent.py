...
from opsdiag.agent import ConversableAgent, ProfileConfig, AgentMessage, Action, BlankAction
...
from opsdiag.util.string_utils import str_to_bool
from IPython.terminal.embed import InteractiveShellEmbed

from opsdiag_ext.agent.agents.open_rca.resource.open_rca_base import OpenRcaScene
...
class DiagRportAssistantAgent(ReportAssistantAgent):
    ...
    def register_variables(self):
        ...
        async def var_cand(instance, context):
            ...
            from opsdiag.agent.resource import ResourceManager
            ...
            from opsdiag_ext.agent.agents.open_rca.resource.open_rca_base import get_open_rca_background
            ...
            from opsdiag_ext.agent.agents.open_rca.resource.open_rca_base import get_open_rca_cand
