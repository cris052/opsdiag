...
from opsdiag.vis.vis_converter import VisProtocolConverter, SystemVisTag
from opsdiag_ext.vis.derisk.tags.drsk_content import DrskContent, DrskTextContent
from opsdiag_ext.vis.derisk.tags.drsk_msg import DrskMsg, DrskMsgContent
from opsdiag_ext.vis.derisk.tags.drsk_thinking import DrskThinking, DrskThinkingContent
...
class DeriskVisConverter(VisProtocolConverter):
    def __init__(self, paths: Optional[str] = None, **kwargs):
        default_tag_paths = ["opsdiag_ext.vis.derisk.tags", "opsdiag_ext.vis.common.tags"]
