...
from opsdiag.agent import ActionOutput
from opsdiag.agent.core.memory.gpts import GptsMessage, GptsPlan
from opsdiag.agent.core.schema import Status, AgentSpaceMode
from opsdiag.vis.vis_converter import SystemVisTag
from opsdiag_ext.vis.derisk.derisk_vis_converter import DrskVisTagPackage
from opsdiag_ext.vis.derisk.derisk_vis_incr_converter import DeriskVisIncrConverter
from opsdiag_ext.vis.derisk.tags.derisk_llm_space import LLMSpace, LLMSpaceContent
from opsdiag_ext.vis.derisk.tags.derisk_running_window import DeriskRunningWindow, RunningWindowContent
from opsdiag_ext.vis.derisk.tags.derisk_work_space import WorkSpaceContent, WorkItem
from opsdiag_ext.vis.derisk.tags.drsk_content import DrskTextContent, DrskContent
from opsdiag_ext.vis.derisk.tags.drsk_thinking import DrskThinkingContent, DrskThinking
from opsdiag_ext.vis.derisk.tags.nex_planning_window import NexPlansContent, NexTaskContent, PlanningWindowContent

from opsdiag_ext.vis.vis_protocol_data import UpdateType
...
class DeriskIncrVisWindow2Converter(DeriskVisIncrConverter):
    ...
    def reuse_name(self):
        ## 复用下面转换器的前端布局
        from opsdiag_ext.vis.derisk.derisk_vis_window_converter import DeriskIncrVisWindowConverter
    ...
    async def _planning_vis_build(self, planning_uid, plans_map: Optional[Dict[str, GptsPlan]] = None,
        ...
        from opsdiag.agent import ResourceType
    ...
    async def _all_running_vis_build(self, messages: List[GptsMessage],
        ...
        from opsdiag_ext.vis.derisk.tags.nex_running_window import RunningContent
