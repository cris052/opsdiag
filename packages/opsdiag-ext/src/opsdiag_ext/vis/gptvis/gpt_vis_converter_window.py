...
from opsdiag_ext.vis.gptvis.gpt_vis_converter import GptVisConverter, GptVisTagPackage
...
class GptVisLRConverter(GptVisConverter):
    ...
    def __init__(self, paths: Optional[str] = None, **kwargs):
        default_tag_paths = ["opsdiag_ext.vis.gptvis.tags", "opsdiag_ext.vis.common.tags"]
