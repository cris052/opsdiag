...
from opsdiag.core.awel.flow import IOField, OperatorCategory, OperatorType, ViewMetadata
...
class KnowledgeProcessBranchOperator(BranchOperator[Knowledge, Knowledge]):
    ...
    async def branches(
        ...
        async def check_graph_process(r: Knowledge) -> bool:
            ...
            from opsdiag.rag.operators import KnowledgeGraphOperator
        ...
        async def check_embedding_process(r: Knowledge) -> bool:
            ...
            from opsdiag.rag.operators import VectorStorageOperator
        ...
        async def check_full_text_process(r: Knowledge) -> bool:
            ...
            from opsdiag.rag.operators.full_text import FullTextStorageOperator
