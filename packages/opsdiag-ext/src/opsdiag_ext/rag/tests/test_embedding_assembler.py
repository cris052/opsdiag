...
from opsdiag_ext.rag.chunk_manager import ChunkParameters, SplitterType
from opsdiag_ext.storage.vector_store.chroma_store import ChromaStore


@pytest.fixture
def mock_db_connection():
    """Create a temporary database connection for testing."""
    from opsdiag_ext.datasource.rdbms.conn_sqlite import SQLiteTempConnector
