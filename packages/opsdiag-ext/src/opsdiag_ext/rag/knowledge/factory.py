...
from opsdiag.rag.knowledge.base import Knowledge, KnowledgeType
from opsdiag_ext.rag.knowledge.string import StringKnowledge
from opsdiag_ext.rag.knowledge.url import URLKnowledge
from opsdiag_ext.rag.knowledge.yuque_url import YUQUEURLKnowledge
...
class KnowledgeFactory:
        ...
        **kwargs: Optional[Dict[str, Union[str, List[str]]]],
        ...
        Examples:
            .. code-block:: python
                ...
                from opsdiag.rag.knowledge.factory import KnowledgeFactory
    ...
    def _get_knowledge_subclasses() -> List["Type[Knowledge]"]:
        """Get all knowledge subclasses."""
        from opsdiag.rag.knowledge.base import Knowledge  # noqa: F401
