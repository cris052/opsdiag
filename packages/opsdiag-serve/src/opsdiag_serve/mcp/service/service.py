...
from opsdiag.agent.resource.tool.mcp.mcp_utils import switch_mcp_input_schema, call_mcp_tool
...
class Service(BaseService[ServeEntity, ServeRequest, ServerResponse]):
    ...
    async def connect_mcp(self, mcp_name: str, headers: Optional[dict]):
        ...
        from opsdiag.agent.resource.tool.mcp.mcp_utils import connect_mcp
    ...
    Optional[List[McpTool]]:
        ...
        from opsdiag.agent.resource.tool.mcp.mcp_utils import get_mcp_tool_list
        mcp_headers = {}
