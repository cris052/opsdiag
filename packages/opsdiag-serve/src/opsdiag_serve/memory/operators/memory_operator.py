...
from opsdiag.agent import Memory, AgentMemory, MemoryFragment, AgentGenerateContext, AgentMessage
from opsdiag.component import ComponentType
from opsdiag.core.awel import MapOperator
from opsdiag.core.awel.flow import ViewMetadata, OperatorCategory, Parameter, IOField
from opsdiag.core.awel.task.base import OUT
...
class PreferenceMemoryWriterOperator(MapOperator[AgentGenerateContext, OUT]):
    ...
    async def map(self, context: AgentGenerateContext) -> OUT:
        ...
        from opsdiag_ext.agent.memory.preference import PreferenceMemoryFragment
