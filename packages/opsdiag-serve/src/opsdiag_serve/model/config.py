...
APP_NAME = "model"
SERVE_APP_NAME = "opsdiag_serve_model"
SERVE_APP_NAME_HUMP = "opsdiag_serve_Model"
SERVE_CONFIG_KEY_PREFIX = "opsdiag_serve.model."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "opsdiag_serve_model"
