...
from opsdiag.core import PromptManager
from opsdiag.storage.metadata import DatabaseManager
from opsdiag_serve.core import BaseServe
...
class Serve(BaseServe):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from opsdiag.core import PromptTemplate
            from opsdiag_serve.prompt.serve import Serve, SERVE_APP_NAME
    ...
    def before_start(self):
        ...
        # import your own module here to ensure the module is loaded before the
        # application starts
        from opsdiag.core.interface.prompt import PromptManager
        from opsdiag.storage.metadata.db_storage import SQLAlchemyStorage
