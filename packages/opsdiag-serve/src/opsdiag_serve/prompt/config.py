...
APP_NAME = "prompt"
SERVE_APP_NAME = "opsdiag_serve_prompt"
SERVE_APP_NAME_HUMP = "opsdiag_serve_Prompt"
SERVE_CONFIG_KEY_PREFIX = "opsdiag.serve.prompt."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "opsdiag_serve_prompt"
