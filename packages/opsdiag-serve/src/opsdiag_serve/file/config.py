...
from opsdiag.core.interface.file import StorageBackendConfig
from opsdiag.util.i18n_utils import _
from opsdiag.util.module_utils import ScannerConfig
from opsdiag_serve.core import BaseServeConfig

APP_NAME = "file"
SERVE_APP_NAME = "opsdiag_serve_file"
SERVE_APP_NAME_HUMP = "opsdiag_serve_File"
SERVE_CONFIG_KEY_PREFIX = "opsdiag.serve.file."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "opsdiag_serve_file"
...
class ServeConfig(BaseServeConfig):
    ...
    __scan_config__ = ScannerConfig(
        module_path="opsdiag_ext.storage.file",
