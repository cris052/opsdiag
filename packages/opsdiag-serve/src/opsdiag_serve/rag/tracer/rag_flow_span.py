...
from opsdiag.util.tracer import Span, MemorySpanStorage
from opsdiag_serve.rag.models.rag_span_db import RagFlowSpanDao


class RagFlowSpanStorage(MemorySpanStorage):
    """opsdiag RAG flow span storage.

    This class is used to store the spans of the opsdiag RAG flow.
    """
