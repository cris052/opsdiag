...
from opsdiag import SystemApp
from opsdiag.core import Chunk, Embeddings
...
from opsdiag_ext.storage import __document_store__ as supported_full_tet_list
from opsdiag_ext.storage import __knowledge_graph__ as supported_kg_store_list
from opsdiag_ext.storage import __vector_store__ as supported_vector_store_list
...
class VectorStoreConnector:
    """The connector for vector store.
        ...
        code example:
        >>> from opsdiag_serve.rag.connector import VectorStoreConnector
    l
    ...
    def from_default(
        ...
        from opsdiag_ext.storage.vector_store.chroma_store import ChromaVectorConfig
    ...
    def _register(self):
        from opsdiag_ext.storage import __all__ as rag_storages
        from opsdiag_ext.storage import _select_rag_storage
