...
from opsdiag.core import MessageStorageItem
from opsdiag.storage.chat_history.chat_history_db import ChatHistoryEntity as ServeEntity
from opsdiag.storage.chat_history.chat_history_db import ChatHistoryMessageEntity
