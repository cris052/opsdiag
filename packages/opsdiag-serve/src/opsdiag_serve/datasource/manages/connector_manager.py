...
from opsdiag.core.awel.flow import ResourceMetadata
from opsdiag.datasource.base import BaseConnector, BaseDatasourceParameters
from opsdiag.util.annotations import Deprecated
from opsdiag.util.executor_utils import ExecutorFactory
from opsdiag.util.parameter_utils import _get_parameter_descriptions
from opsdiag_ext.datasource.schema import DBType
from opsdiag_serve.core import ResourceParameters, ResourceTypes
...
class ConnectorManager(BaseComponent):
    ...
    def on_init(self):
        ...
        """
        from opsdiag.datasource.rdbms.base import RDBMSConnector  # noqa: F401
        from opsdiag_ext.datasource.conn_tugraph import TuGraphConnector  # noqa: F401

        from opsdiag_ext.datasource.rdbms.conn_mysql import MySQLConnector  # noqa: F401
        from opsdiag_ext.datasource.rdbms.conn_oceanbase import (  # noqa: F401
            OceanBaseConnector,
        )
        from opsdiag_ext.datasource.rdbms.conn_postgresql import (  # noqa: F401
            PostgreSQLConnector,
        )
        from opsdiag_ext.datasource.rdbms.conn_sqlite import (
