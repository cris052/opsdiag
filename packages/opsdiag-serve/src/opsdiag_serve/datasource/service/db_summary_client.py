...
from opsdiag.core import Embeddings
from opsdiag.rag.embedding.embedding_factory import EmbeddingFactory
from opsdiag.rag.text_splitter.text_splitter import RDBTextSplitter
from opsdiag.storage.vector_store.base import VectorStoreBase
from opsdiag_ext.rag import ChunkParameters
from opsdiag_ext.rag.summary.gdbms_db_summary import GdbmsSummary
from opsdiag_ext.rag.summary.rdbms_db_summary import RdbmsSummary
from opsdiag_serve.datasource.manages import ConnectorManager
...
class DBSummaryClient:
    ...
    def get_db_summary(self, dbname, query, topk):
        ...
        from opsdiag_ext.rag.retriever.db_schema import DBSchemaRetriever
    ...
    def init_db_profile(self, db_summary_client, dbname):
        ...
        if not table_vector_connector.vector_name_exists():
            from opsdiag_ext.rag.assembler.db_schema import DBSchemaAssembler
            from opsdiag_ext.rag.summary.rdbms_db_summary import (
