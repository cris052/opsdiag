...
from opsdiag.core.interface.variables import (
...
class BuiltinFlowVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all flows by variables "${opsdiag.core.flow.flows}"
    """
...
class BuiltinNodeVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all nodes by variables "${opsdiag.core.flow.nodes}"
    """
    ...
    def get_variables(
        ...
        from opsdiag.core.awel.flow.base import _OPERATOR_REGISTRY
...
class BuiltinAllVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all variables by variables "${opsdiag.core.variables}"
    """
...
class BuiltinAllSecretVariablesProvider(BuiltinAllVariablesProvider):
    ...
    Provide all secret variables by variables "${opsdiag.core.secrets}"
    """
...
class BuiltinLLMVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all LLM variables by variables "${opsdiag.core.llmv}"
    """
    ...
    async def _get_models(
        ...
        from opsdiag.model.cluster.controller.controller import BaseModelController
...
class BuiltinEmbeddingsVariablesProvider(BuiltinLLMVariablesProvider):
    ...
    Provide all embeddings variables by variables "${opsdiag.core.embeddings}"
    """
...
class BuiltinDatasourceVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all datasource variables by variables "${opsdiag.core.datasource}"
    """
    ...
    def get_variables(
        ...
        """Get the builtin variables."""
        from opsdiag_serve.datasource.service.service import (
...
class BuiltinAgentsVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all agents variables by variables "${opsdiag.core.agent.agents}"
    """
    ...
    def get_variables(
        ...
        """Get the builtin variables."""
        from opsdiag.agent.core.agent_manage import get_agent_manager
...
class BuiltinKnowledgeSpacesVariablesProvider(BuiltinVariablesProvider):
    ...
    Provide all knowledge variables by variables "${opsdiag.core.knowledge_spaces}"
    """
    ...
    def get_variables(
        ...
        """Get the builtin variables."""
        from opsdiag_serve.rag.service.service import Service, SpaceServeRequest
