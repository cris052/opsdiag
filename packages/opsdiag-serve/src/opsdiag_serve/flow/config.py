...
APP_NAME = "flow"
SERVE_APP_NAME = "opsdiag_serve_flow"
SERVE_APP_NAME_HUMP = "opsdiag_serve_Flow"
SERVE_CONFIG_KEY_PREFIX = "opsdiag.serve.flow."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
SERVE_VARIABLES_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_variables_service"
# Database table name
SERVER_APP_TABLE_NAME = "opsdiag_serve_flow"
SERVER_APP_VARIABLES_TABLE_NAME = "opsdiag_serve_variables"
