...
from opsdiag_serve.core import Result
from opsdiag_serve.evaluate.api.schemas import EvaluateServeRequest
from opsdiag_serve.evaluate.config import SERVE_SERVICE_COMPONENT_NAME, ServeConfig
from opsdiag_serve.evaluate.service.service import Service
...
def get_prompt_service() -> PromptService:
    return global_system_app.get_component("opsdiag_serve_prompt_service", PromptService)
