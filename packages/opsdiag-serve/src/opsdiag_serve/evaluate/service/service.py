...
from opsdiag.rag.evaluation import RetrieverEvaluator
from opsdiag.rag.evaluation.answer import AnswerRelevancyMetric
from opsdiag.rag.evaluation.retriever import RetrieverSimilarityMetric
from opsdiag.storage.metadata import BaseDao
from opsdiag.storage.vector_store.base import VectorStoreConfig
from opsdiag_serve.rag.operators.knowledge_space import SpaceRetrieverOperator
...
def get_prompt_service(system_app) -> PromptService:
    return system_app.get_component("opsdiag_serve_prompt_service", PromptService)
