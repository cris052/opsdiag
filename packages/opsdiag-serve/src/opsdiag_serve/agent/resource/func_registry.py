...
from opsdiag.agent.resource.tool.base import ToolFunc, FunctionTool
from opsdiag_serve.agent.db.gpts_tool import GptsToolDao, GptsTool
...
class CentralFunctionRegistry:
    ...
    def scan_register_and_save(self, system_app: SystemApp):
        ...
        TOOL_MODULES_PACKAGE = 'opsdiag_ext.agent.agents'
