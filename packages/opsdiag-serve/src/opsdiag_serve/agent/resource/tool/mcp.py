...
from opsdiag.agent.resource.tool.pack import json_parse_execute_args_func
from opsdiag_app.config import ApplicationConfig
from opsdiag_serve.agent.resource.tool.mcp_utils import get_mcp_tool_list, switch_mcp_input_schema, call_mcp_tool

from tenacity import retry, stop_after_attempt, wait_fixed, after_log, before_sleep_log
from mcp.types import Tool
from opsdiag.util.global_helper import truncate_text
from opsdiag.agent.resource import PackResourceParameters, ToolPack, BaseTool
from opsdiag.util import ParameterDescription
from opsdiag.util.i18n_utils import _

from opsdiag_serve.agent.db.gpts_tool import GptsToolDao
from opsdiag_serve.agent.db.gpts_tool_messages import GptsToolMessagesDao, GptsToolMessages
...
class MCPToolPack(ToolPack):
    ...
    def __init__(
        ...
        from opsdiag.util.log_util import MCP_LOGGER as LOGGER
