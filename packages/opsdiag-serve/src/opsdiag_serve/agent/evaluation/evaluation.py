...
from opsdiag.core import Embeddings, LLMClient
from opsdiag.core.awel import IteratorTrigger, JoinOperator, MapOperator
from opsdiag.core.awel.task.base import IN, OUT
from opsdiag.core.interface.evaluation import (
...
from opsdiag.rag.evaluation import RetrieverSimilarityMetric
...
class AgentEvaluator(Evaluator):
    ...
    Examples:
        .. code-block:: python
            ...
            import os
            import asyncio
            from opsdiag.rag.operators import (
                EmbeddingRetrieverOperator,
                RetrieverEvaluatorOperator,
            )
            from opsdiag.rag.evaluation import (
                RetrieverEvaluator,
                RetrieverSimilarityMetric,
            )
            from opsdiag.rag.embedding import DefaultEmbeddingFactory
            ...
            from opsdiag.configs.model_config import MODEL_PATH, PILOT_PATH
    ...
    async def evaluate(
        ...
        **kwargs,
        ...
        from opsdiag.core.awel import DAG, MapOperator
